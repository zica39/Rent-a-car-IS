...
@section('content')
    ...
    @include('client.layouts.breadcrumb',['page' => 'Reservation','path'=>['Home','Our Cars','Reservations','Reservation']])
    <!-- cart_section - start
			================================================== -->
    <section class="cart_section sec_ptb_100 clearfix">
        <div class="container">
            <div class="row justify-content-lg-between justify-content-md-center justify-content-sm-center my-4" >
                ...
                <div class="col-lg-8 col-md-9 col-sm-10 col-xs-12">
                    <div class="cart_info_content">
                        ...
                        <ul class="cart_info_list2 ul_li_block clearfix" data-aos="fade-up" data-aos-delay="100">
                            <li><strong>Total price:</strong> {{$reservation->total_price}}€ @if($reservation->isActive())<span class="float-right"><i class="fa fa-check text-success"></i> Active</span>@endif</li>
                        </ul>
