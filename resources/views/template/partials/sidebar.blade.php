<div class="sidebar">
    <div class="sidebar-inner">
                ...
                <div class="peer peer-greed">
                    <a class="sidebar-link td-n" href="/home">
                        <div class="peers ai-c fxw-nw">
                            ...
                            <div class="peer peer-greed">
                                <h5 class="lh-1 mB-0 logo-text">Rent-a car</h5></div>
                        </div>
                    </a>
                </div>
                <div class="peer">
        ...
        <ul class="sidebar-menu scrollable pos-r">
            <li class="nav-item mT-30 actived"><a class="sidebar-link" href="/dashboard"><span class="icon-holder"><i class="c-blue-500 ti-home"></i> </span><span class="title">Dashboard</span></a></li>
            <li class="nav-item"><a class="sidebar-link" href="/user"><span class="icon-holder"><i class="c-blue-500 ti-user"></i> </span><span class="title">Users</span></a></li>
            <li class="nav-item"><a class="sidebar-link" href="/car"><span class="icon-holder"><i class="c-blue-500 ti-car"></i> </span><span class="title">Cars</span></a></li>
            <li class="nav-item"><a class="sidebar-link" href="/calendar"><span class="icon-holder"><i class="c-deep-orange-500 ti-calendar"></i> </span><span class="title">Reservations</span></a></li>
{{--            <li class="nav-item"><a class="sidebar-link" href="/codebook"><span class="icon-holder"><i class="c-deep-pink-500 ti-book"></i> </span><span class="title">CodeBook</span></a></li>--}}
            <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span class="icon-holder"><i class="c-orange-500 ti-book"></i> </span><span class="title">CodeBook</span> <span class="arrow"><i class="ti-angle-right"></i></span></a>
                <ul class="dropdown-menu">
                    <li><a class="sidebar-link" href="/codebook?name=country">Country</a></li>
                    <li><a class="sidebar-link" href="/codebook?name=accessory">Accessory</a></li>
                    <li><a class="sidebar-link" href="/codebook?name=class">Car Class</a></li>
                    <li><a class="sidebar-link" href="/codebook?name=location">Location</a></li>
                </ul>
            </li>
...
{{--            <li class="nav-item"><a class="sidebar-link" href="/compose"><span class="icon-holder"><i class="c-blue-500 ti-share"></i> </span><span class="title">Compose</span></a></li>--}}
            ...
            {{--<li class="nav-item"><a class="sidebar-link" href="/charts"><span class="icon-holder"><i class="c-indigo-500 ti-bar-chart"></i> </span><span class="title">Charts</span></a></li>
            <li class="nav-item"><a class="sidebar-link" href="/forms"><span class="icon-holder"><i class="c-light-blue-500 ti-pencil"></i> </span><span class="title">Forms</span></a></li>
            <li class="nav-item dropdown"><a class="sidebar-link" href="/ui"><span class="icon-holder"><i class="c-pink-500 ti-palette"></i> </span><span class="title">UI Elements</span></a></li>
